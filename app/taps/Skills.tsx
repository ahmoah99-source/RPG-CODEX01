  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="اسم الموهبة (مثال: تسريع الخلايا العصبية)" placeholderTextColor="#94a3b8" value={name} onChangeText={setName} />
        <TextInput style={styles.input} placeholder="المضاعف الإحصائي (مثال: 1.5 لزيادة 50%)" placeholderTextColor="#94a3b8" keyboardType="numeric" value={multiplier} onChangeText={setMultiplier} />
        <TextInput style={styles.input} placeholder="زيادة رقمية ثابتة (اختياري)" placeholderTextColor="#94a3b8" keyboardType="numeric" value={staticBoost} onChangeText={setStaticBoost} />
